...
status.Size = UDim2.new(1,-30,1,-80)
...
local function QuestCheck()
    ...
    if World1 then
        if lvl <= 9 then q.Mon = "Bandit" q.QName = "BanditQuest1" q.QData = 1 q.PosQ = CFrame.new(1059, 17, 1546) q.PosM = CFrame.new(943, 45, 1562)
        elseif lvl <= 14 then q.Mon = "Monkey" q.QName = "JungleQuest" q.QData = 1 q.PosQ = CFrame.new(-1598, 37, 153) q.PosM = CFrame.new(-1524, 50, 37)
        elseif lvl <= 29 then q.Mon = "Gorilla" q.QName = "JungleQuest" q.QData = 2 q.PosQ = CFrame.new(-1598, 37, 153) q.PosM = CFrame.new(-1128, 40, -451)
        elseif lvl <= 39 then q.Mon = "Pirate" q.QName = "BuggyQuest1" q.QData = 1 q.PosQ = CFrame.new(-1140, 4, 3829) q.PosM = CFrame.new(-1262, 40, 3905)
        elseif lvl <= 59 then q.Mon = "Brute" q.QName = "BuggyQuest1" q.QData = 2 q.PosQ = CFrame.new(-1140, 4, 3829) q.PosM = CFrame.new(-976, 55, 4304)
        elseif lvl <= 74 then q.Mon = "Desert Bandit" q.QName = "DesertQuest" q.QData = 1 q.PosQ = CFrame.new(897, 6, 4389) q.PosM = CFrame.new(924, 7, 4482)
        elseif lvl <= 89 then q.Mon = "Desert Officer" q.QName = "DesertQuest" q.QData = 2 q.PosQ = CFrame.new(897, 6, 4389) q.PosM = CFrame.new(1608, 9, 4371)
        elseif lvl <= 99 then q.Mon = "Snow Bandit" q.QName = "SnowQuest" q.QData = 1 q.PosQ = CFrame.new(1385, 87, -1298) q.PosM = CFrame.new(1362, 120, -1531)
        elseif lvl <= 119 then q.Mon = "Snowman" q.QName = "SnowQuest" q.QData = 2 q.PosQ = CFrame.new(1385, 87, -1298) q.PosM = CFrame.new(1243, 140, -1437)
        elseif lvl <= 149 then q.Mon = "Chief Petty Officer" q.QName = "MarineQuest2" q.QData = 1 q.PosQ = CFrame.new(-5035, 29, 4326) q.PosM = CFrame.new(-4881, 23, 4274)
        elseif lvl <= 174 then q.Mon = "Sky Bandit" q.QName = "SkyQuest" q.QData = 1 q.PosQ = CFrame.new(-4844, 718, -2621) q.PosM = CFrame.new(-4953, 296, -2899)
        elseif lvl <= 189 then q.Mon = "Dark Master" q.QName = "SkyQuest" q.QData = 2 q.PosQ = CFrame.new(-4844, 718, -2621) q.PosM = CFrame.new(-5260, 391, -2229)
        elseif lvl <= 209 then q.Mon = "Prisoner" q.QName = "PrisonerQuest" q.QData = 1 q.PosQ = CFrame.new(5306, 2, 477) q.PosM = CFrame.new(5099, 0, 474)
        elseif lvl <= 249 then q.Mon = "Dangerous Prisoner" q.QName = "PrisonerQuest" q.QData = 2 q.PosQ = CFrame.new(5306, 2, 477) q.PosM = CFrame.new(5655, 16, 866)
        elseif lvl <= 274 then q.Mon = "Toga Warrior" q.QName = "ColosseumQuest" q.QData = 1 q.PosQ = CFrame.new(-1581, 7, -2982) q.PosM = CFrame.new(-1820, 51, -2741)
        elseif lvl <= 299 then q.Mon = "Gladiator" q.QName = "ColosseumQuest" q.QData = 2 q.PosQ = CFrame.new(-1581, 7, -2982) q.PosM = CFrame.new(-1268, 30, -2996)
        elseif lvl <= 324 then q.Mon = "Military Soldier" q.QName = "MagmaQuest" q.QData = 1 q.PosQ = CFrame.new(-5319, 12, 8515) q.PosM = CFrame.new(-5335, 46, 8638)
        elseif lvl <= 374 then q.Mon = "Military Spy" q.QName = "MagmaQuest" q.QData = 2 q.PosQ = CFrame.new(-5319, 12, 8515) q.PosM = CFrame.new(-5803, 86, 8829)
        elseif lvl <= 399 then q.Mon = "Fishman Warrior" q.QName = "FishmanQuest" q.QData = 1 q.PosQ = CFrame.new(61122, 18, 1567) q.PosM = CFrame.new(60998, 50, 1534)
        elseif lvl <= 449 then q.Mon = "Fishman Commando" q.QName = "FishmanQuest" q.QData = 2 q.PosQ = CFrame.new(61122, 18, 1567) q.PosM = CFrame.new(61866, 55, 1655)
        elseif lvl <= 474 then q.Mon = "God's Guard" q.QName = "SkyExp1Quest" q.QData = 1 q.PosQ = CFrame.new(-4720, 846, -1951) q.PosM = CFrame.new(-4720, 846, -1951)
        elseif lvl <= 524 then q.Mon = "Shanda" q.QName = "SkyExp1Quest" q.QData = 2 q.PosQ = CFrame.new(-7861, 5545, -381) q.PosM = CFrame.new(-7741, 5580, -395)
        elseif lvl <= 549 then q.Mon = "Royal Squad" q.QName = "SkyExp2Quest" q.QData = 1 q.PosQ = CFrame.new(-7903, 5636, -1412) q.PosM = CFrame.new(-7727, 5650, -1410)
        elseif lvl <= 624 then q.Mon = "Royal Soldier" q.QName = "SkyExp2Quest" q.QData = 2 q.PosQ = CFrame.new(-7903, 5636, -1412) q.PosM = CFrame.new(-7894, 5640, -1629)
        elseif lvl <= 649 then q.Mon = "Galley Pirate" q.QName = "FountainQuest" q.QData = 1 q.PosQ = CFrame.new(5258, 39, 4052) q.PosM = CFrame.new(5391, 70, 4023)
        elseif lvl >= 650 then q.Mon = "Galley Captain" q.QName = "FountainQuest" q.QData = 2 q.PosQ = CFrame.new(5258, 39, 4052) q.PosM = CFrame.new(5985, 70, 4790)
        end
    elseif World2 then
        if lvl <= 724 then q.Mon = "Raider" q.QName = "Area1Quest" q.QData = 1 q.PosQ = CFrame.new(-427, 73, 1835) q.PosM = CFrame.new(-614, 90, 2240)
        elseif lvl <= 774 then q.Mon = "Mercenary" q.QName = "Area1Quest" q.QData = 2 q.PosQ = CFrame.new(-427, 73, 1835) q.PosM = CFrame.new(-867, 110, 1621)
        elseif lvl <= 874 then q.Mon = "Swan Pirate" q.QName = "Area2Quest" q.QData = 1 q.PosQ = CFrame.new(635, 73, 919) q.PosM = CFrame.new(635, 73, 919)
        elseif lvl <= 899 then q.Mon = "Marine Lieutenant" q.QName = "MarineQuest3" q.QData = 1 q.PosQ = CFrame.new(-2441, 73, -3219) q.PosM = CFrame.new(-2552, 110, -3050)
        elseif lvl <= 949 then q.Mon = "Marine Captain" q.QName = "MarineQuest3" q.QData = 2 q.PosQ = CFrame.new(-2441, 73, -3219) q.PosM = CFrame.new(-1695, 110, -3299)
        elseif lvl <= 974 then q.Mon = "Zombie" q.QName = "ZombieQuest" q.QData = 1 q.PosQ = CFrame.new(-5495, 48, -794) q.PosM = CFrame.new(-5715, 90, -917)
        elseif lvl <= 999 then q.Mon = "Vampire" q.QName = "ZombieQuest" q.QData = 2 q.PosQ = CFrame.new(-5495, 48, -794) q.PosM = CFrame.new(-6027, 50, -1130)
        elseif lvl <= 1049 then q.Mon = "Snow Trooper" q.QName = "SnowMountainQuest" q.QData = 1 q.PosQ = CFrame.new(607, 401, -5371) q.PosM = CFrame.new(445, 440, -5175)
        elseif lvl <= 1099 then q.Mon = "Winter Warrior" q.QName = "SnowMountainQuest" q.QData = 2 q.PosQ = CFrame.new(607, 401, -5371) q.PosM = CFrame.new(1224, 460, -5332)
        elseif lvl <= 1124 then q.Mon = "Lab Subordinate" q.QName = "IceSideQuest" q.QData = 1 q.PosQ = CFrame.new(-6061, 16, -4904) q.PosM = CFrame.new(-5941, 50, -4322)
        elseif lvl <= 1174 then q.Mon = "Horned Warrior" q.QName = "IceSideQuest" q.QData = 2 q.PosQ = CFrame.new(-6061, 16, -4904) q.PosM = CFrame.new(-6306, 50, -5752)
        elseif lvl <= 1199 then q.Mon = "Magma Ninja" q.QName = "FireSideQuest" q.QData = 1 q.PosQ = CFrame.new(-5430, 16, -5298) q.PosM = CFrame.new(-5233, 60, -6227)
        elseif lvl <= 1249 then q.Mon = "Lava Pirate" q.QName = "FireSideQuest" q.QData = 2 q.PosQ = CFrame.new(-5430, 16, -5298) q.PosM = CFrame.new(-4955, 60, -4836)
        elseif lvl <= 1274 then q.Mon = "Ship Deckhand" q.QName = "ShipQuest1" q.QData = 1 q.PosQ = CFrame.new(1033, 125, 32909) q.PosM = CFrame.new(1033, 125, 32909)
        elseif lvl <= 1299 then q.Mon = "Ship Engineer" q.QName = "ShipQuest1" q.QData = 2 q.PosQ = CFrame.new(1033, 125, 32909) q.PosM = CFrame.new(809, 80, 33090)
        elseif lvl <= 1324 then q.Mon = "Ship Steward" q.QName = "ShipQuest2" q.QData = 1 q.PosQ = CFrame.new(973, 125, 33245) q.PosM = CFrame.new(838, 160, 33408)
        elseif lvl <= 1349 then q.Mon = "Ship Officer" q.QName = "ShipQuest2" q.QData = 2 q.PosQ = CFrame.new(973, 125, 33245) q.PosM = CFrame.new(1238, 220, 33148)
        elseif lvl <= 1374 then q.Mon = "Arctic Warrior" q.QName = "FrostQuest" q.QData = 1 q.PosQ = CFrame.new(5669, 28, -6484) q.PosM = CFrame.new(5669, 28, -6484)
        elseif lvl <= 1424 then q.Mon = "Snow Lurker" q.QName = "FrostQuest" q.QData = 2 q.PosQ = CFrame.new(5669, 28, -6484) q.PosM = CFrame.new(5669, 28, -6484)
        elseif lvl <= 1449 then q.Mon = "Sea Soldier" q.QName = "ForgottenQuest" q.QData = 1 q.PosQ = CFrame.new(-3052, 237, -10142) q.PosM = CFrame.new(-3052, 237, -10142)
    ...
    elseif World3 then
        ...
        elseif lvl <= 2699 then q.Mon = "Ocean Prophet" q.QName = "SubmergedQuest2" q.QData = 2 q.PosQ = CFrame.new(10882.264, -2086.322, 10034.226) q.PosM = CFrame.new(11056.1445, -2001.6717, 10117.4493)
        elseif lvl <= 2724 then q.Mon = "High Disciple" q.QName = "SubmergedQuest3" q.QData = 1 q.PosQ = CFrame.new(9636.52441, -1992.19507, 9609.52832) q.PosM = CFrame.new(9828.087890625, -1940.908935546875, 9693.0634765625)
...
repeat task.wait() until plr.Character and plr.Character:FindFirstChild("HumanoidRootPart") and plr.Data.Level.Value > 0 and plr.Data.Stats and plr.Backpack
task.wait(10)
